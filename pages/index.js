  ...
  return(
    ...
    <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
      ...
      h-full container mx-auto">
        {/*title */}
        <h1  variants={fadeIn('down', 0.2)} initial='hidden' animate='show' exit='hidden'
        className="h1">
        ...
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas elementum eget ex non feugiat. Orci varius natoque penatibus et magnis. 
        </motion.p>
